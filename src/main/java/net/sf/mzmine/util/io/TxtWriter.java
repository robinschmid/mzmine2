...
public class TxtWriter {
   ...
   * @return
   */
  public List<String> readLinesBuffered(String file) throws IOException {
   ...
   * @return
   */
  public List<String> readLinesBuffered(File file) throws IOException {
    try {
      String encoding = UniversalDetector.detectCharset(file);
      try {
   ...
   * @return
   */
  public List<String> readLinesBuffered(File file, String encoding) throws IOException {
   ...
   * @return
   */
  public List<String> readLinesOLD(File file) {
    List<String> sList = new ArrayList<String>();
    try {
      scanner = new Scanner(file);
      String line;
  ...
  public void openNewFileOutput(String file) {
    openNewFileOutput(new File(file));
  }

  public void openNewFileOutput(File f) {
    try {
      if (!f.exists()) {
