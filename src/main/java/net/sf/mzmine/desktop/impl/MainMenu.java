...
public class MainMenu extends JMenuBar implements ActionListener {
  ...
  MainMenu() {
    ...
    projectSampleParameters =
        GUIUtils.addMenuItem(projectMenu, "Set sample parameters", this, KeyEvent.VK_P);
    ...
    projectSaveParameters = GUIUtils.addMenuItem(projectMenu, "Save MZmine parameters", this);
    projectLoadParameters = GUIUtils.addMenuItem(projectMenu, "Load MZmine parameters", this);
  ...
  public synchronized void addMenuItem(MZmineModuleCategory parentMenu, JMenuItem newItem) {
    switch (parentMenu) {
      case PROJECTIO:
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (module != null) {
      ...
      ExitCode exitCode =
          moduleParameters.showSetupDialog(MZmineCore.getDesktop().getMainWindow(), true);
