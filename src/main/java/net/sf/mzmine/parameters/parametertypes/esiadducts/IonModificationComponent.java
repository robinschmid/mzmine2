...
import net.sf.mzmine.modules.peaklistmethods.identification.metamsecorrelate.msannotation.actions.DefaultESIAdductsNegativeAction;
import net.sf.mzmine.modules.peaklistmethods.identification.metamsecorrelate.msannotation.actions.DefaultESIModsAction;
import net.sf.mzmine.modules.peaklistmethods.identification.metamsecorrelate.msannotation.actions.ExportESIAdductsAction;
import net.sf.mzmine.modules.peaklistmethods.identification.metamsecorrelate.msannotation.actions.ImportESIAdductsAction;
