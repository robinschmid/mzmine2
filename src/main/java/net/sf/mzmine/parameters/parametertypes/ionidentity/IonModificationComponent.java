...
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.AddIonModificationAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.CombineESIAdductsAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.DefaultIonModificationAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.DefaultAdductsNegativeAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.DefaultNeutralModificationAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.ExportIonModificationAction;
import net.sf.mzmine.modules.peaklistmethods.identification.ionidentity.ionannotation.actions.ImportIonModificationAction;
