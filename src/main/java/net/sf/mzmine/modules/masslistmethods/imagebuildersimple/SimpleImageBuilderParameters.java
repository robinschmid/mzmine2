...
public class SimpleImageBuilderParameters extends SimpleParameterSet {
  ...
  public static final IntegerParameter minimumScans =
      new IntegerParameter("Min # of scans", "Minimum number of scans.");
  public static final PercentParameter minimumScanPerc =
      new PercentParameter("Min % of scans", "Minimum number of scans relative to all scans.");
  ...
  public SimpleImageBuilderParameters() {
    super(new Parameter[] {dataFiles, scanSelection, massList, mzRange, rtRange, minimumHeight,
        minimumScans, minimumScanPerc, binWidth, mzTolerance, weight, suffix});
  }
