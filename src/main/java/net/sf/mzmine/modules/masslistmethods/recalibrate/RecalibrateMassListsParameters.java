...
public class RecalibrateMassListsParameters extends SimpleParameterSet {
    ...
    public static final DoubleParameter minimumHeight = new DoubleParameter(
            "Min height",
            "Minimum intensity of the internal lock masses",
            MZmineCore.getConfiguration().getIntensityFormat());
    
    public static final MZToleranceParameter mzTolerance = new MZToleranceParameter();

    public static final StringParameter suffix = new StringParameter("Suffix",
            "This string is added to filename as suffix", "image");

    public RecalibrateMassListsParameters() {
