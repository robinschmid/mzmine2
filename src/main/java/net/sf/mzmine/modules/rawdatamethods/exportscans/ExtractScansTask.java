...
class ExtractScansTask extends AbstractTask {
	...
	ExtractScansTask(ParameterSet parameters) { 
		dataFiles = Arrays.asList(parameters
				.getParameter(ExtractScansParameters.dataFiles).getValue()
		...
		massList = parameters.getParameter(ExtractScansParameters.useMassList).getEmbeddedParameter().getValue(); 
