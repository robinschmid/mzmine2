...
public class ClusterSpectraParameters extends SimpleParameterSet {
  ...
  public static final DoubleParameter minCosine =
      new DoubleParameter("Min similarity", "Minimum cosine similarity (default=0.9)",
          MZmineCore.getConfiguration().getIntensityFormat(), 0.9);
