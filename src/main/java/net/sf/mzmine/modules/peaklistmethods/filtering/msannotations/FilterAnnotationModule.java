...
public class FilterAnnotationModule implements MZmineProcessingModule {
  ...
  public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
    ...
    return FilterAnnotationParameters.class;
  }
  ...
  public ExitCode runModule(@Nonnull MZmineProject project, @Nonnull final ParameterSet parameters,
    ...
    PeakList[] pkl = parameters.getParameter(FilterAnnotationParameters.PEAK_LISTS).getValue()
        .getMatchingPeakLists();
    for (PeakList p : pkl)
      tasks.add(new FilterAnnotationTask(project, parameters, p));
