 ...
 * USA
 */
package net.sf.mzmine.modules.peaklistmethods.identification.formulaprediction.createavgformulas;
...
public class CreateAvgNetworkFormulasModule implements MZmineProcessingModule {
  ...
  public @Nonnull ExitCode runModule(@Nonnull MZmineProject project,
    ...
    PeakList peakLists[] = parameters.getParameter(CreateAvgNetworkFormulasParameters.PEAK_LISTS)
        .getValue().getMatchingPeakLists();

    for (PeakList peakList : peakLists) {
      Task newTask = new CreateAvgNetworkFormulasTask(peakList, parameters);
      tasks.add(newTask);
    }
    return ExitCode.OK;
  }
