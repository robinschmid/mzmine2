...
public class AlignedIsotopeGrouperParameters extends SimpleParameterSet {
    ...
    public static final OptionalParameter<IntegerParameter> minMatchRawDP = new OptionalParameter<>(new IntegerParameter(
    	    "Minimum matched raw DP",
    	    "Minimum matched raw data points for filling in missing charge states.",3,1,100000));
    ...
    public AlignedIsotopeGrouperParameters() {
	super(new Parameter[] { peakLists, massList, suffix, mzTolerance, rtTolerance,
		monotonicShape, maximumCharge, minMatchRawDP, representativeIsotope,
		autoRemove });
    }
