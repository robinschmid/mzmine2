 ...
 * 
 */
public class DefaultESIModsAction extends AbstractAction {
	/**
	 * 
	 */
	 ...
	 * Create the action.
	 */
	public DefaultESIModsAction(MultiChoiceComponent parent) {
		super("Reset mods");
	...
	public void actionPerformed(final ActionEvent e) { 
		if (parent != null) {
			...
			parent.setChoices(ESIAdductType.getDefaultModifications());
		}
	}
}