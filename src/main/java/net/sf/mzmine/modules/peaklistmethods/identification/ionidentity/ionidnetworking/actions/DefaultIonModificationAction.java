 ...
 * 
 */
public class DefaultIonModificationAction extends AbstractAction {
	/**
	 * 
	 */
	 ...
	 * Create the action.
	 */
	public DefaultIonModificationAction(MultiChoiceComponent parent) {
		super("Reset positive");
	...
	public void actionPerformed(final ActionEvent e) { 
		if (parent != null) {
			...
			parent.setChoices(IonModification.getDefaultValuesPos());
		}
	}
}