...
public class MS2SimilarityModule implements MZmineProcessingModule {
  ...
  private static final String NAME = "MS2 similarity check on groups";

  private static final String DESCRIPTION = "Checks MS2 similarity of all rows within the groups";
