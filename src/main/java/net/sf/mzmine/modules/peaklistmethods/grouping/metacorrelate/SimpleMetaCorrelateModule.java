...
public class SimpleMetaCorrelateModule implements MZmineProcessingModule {

  private static final String NAME = "metaCorrelate (simple)";
  ...
  public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
    return SimpleMetaCorrelateParameters.class;
  }
  ...
  public ExitCode runModule(@Nonnull MZmineProject project, @Nonnull final ParameterSet parameters,
    ...
    PeakList[] peakLists = parameters.getParameter(SimpleMetaCorrelateParameters.PEAK_LISTS)
        .getValue().getMatchingPeakLists();
    for (PeakList pkl : peakLists)
      tasks.add(new SimpleMetaCorrelateTask(project, parameters, pkl));
