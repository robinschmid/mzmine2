...
public class FormulaSortParameters extends SimpleParameterSet {
  ...
  public static final DoubleParameter MAX_PPM_WEIGHT = new DoubleParameter(
      "Max ppm distance (weight)", "Score is calculated as (ppm distance-ppmMax)/ppmMax", 10d);

  public static final DoubleParameter ISOTOPE_SCORE_WEIGHT =
      new DoubleParameter("Weight isotope pattern score", "Weight for isotope pattern score", 1d);

  public static final DoubleParameter MSMS_SCORE_WEIGHT =
      new DoubleParameter("Weight MS/MS score", "Weight for MS/MS score", 1d);
