...
import net.sf.mzmine.modules.peaklistmethods.isotopes.aligneddeisotoper.AlignedIsotopeGrouperModule;
...
import net.sf.mzmine.modules.visualization.metamsecorrelate.visual.sub.corrhisto.CorrHistoModule;
import net.sf.mzmine.modules.visualization.metamsecorrelate.visual.sub.networks.annotationnetwork.AnnotationNetworkModule;
import net.sf.mzmine.modules.visualization.metamsecorrelate.visual.sub.networks.corrnetwork.CorrNetworkModule;
import net.sf.mzmine.modules.visualization.metamsecorrelate.visual.sub.networks.rtnetwork.RTNetworkModule;
...
public class MZmineModulesList {
  ...
  public static final Class<?> MODULES[] = new Class<?>[] {
      ...
      // Isotopes
      IsotopeGrouperModule.class, AlignedIsotopeGrouperModule.class, IsotopePatternCalculator.class,
      ...
      MetaMSEcorrelateModule.class, MSAnnotationModule.class,
